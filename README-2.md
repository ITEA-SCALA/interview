...
8. Посредник — ослабляет связь между компонентами системы (делегировать взаимодействия через объект-посредник)
9. Цепочка обязанностей — разделяет сложное действие в цепочку обработчиков
